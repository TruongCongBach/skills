...
progressive_disclosure:
  entry_point:
    summary: "Turn completed implementation context into clear handoff summaries for ticket history, QA, and engineering readers."
    ...
    quick_start: "1. Read ticket and implementation context 2. Identify root cause and fix approach 3. Summarize changed areas and risks 4. Add QA focus and test scenarios 5. Produce short handoff summaries and titles"
  references:
...
6. Call out regression risks and QA focus areas.
